...
const navItems: { view: View; icon: typeof LayoutDashboard; label: string }[] = [
  { view: 'vendor-dashboard', icon: LayoutDashboard, label: 'Domov' },
  { view: 'vendor-orders', icon: ClipboardList, label: 'Objednávky' },
  { view: 'vendor-menu', icon: UtensilsCrossed, label: 'Menu' },
  { view: 'vendor-settings', icon: Settings, label: 'Nastavenia' },
]
